...
def send_daily_likes_notification():
    ...
    """
    try:
        logger.info('Enter send_daily_likes_notification')
        ...
        for user in users:
            ...
            if liked_recipes.exists():
                ...
                email_html_message = render_to_string('users/daily_likes_notification.html', context)
                email_plaintext_message = render_to_string('users/daily_likes_notification.txt', context)
                ...
                msg.send()
        logger.info('Exit send_daily_likes_notification: success')
